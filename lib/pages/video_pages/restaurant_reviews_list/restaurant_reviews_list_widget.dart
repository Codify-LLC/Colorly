...
import 'restaurant_reviews_list_model.dart';
export 'restaurant_reviews_list_model.dart';

class RestaurantReviewsListWidget extends StatefulWidget {
  const RestaurantReviewsListWidget({
    Key? key,
  ...
  @override
  _RestaurantReviewsListWidgetState createState() =>
      _RestaurantReviewsListWidgetState();
}

class _RestaurantReviewsListWidgetState
    extends State<RestaurantReviewsListWidget> with TickerProviderStateMixin {
  late RestaurantReviewsListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RestaurantReviewsListModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'restaurantReviewsList'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<RestaurantsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RestaurantsRecord> restaurantReviewsListRestaurantsRecordList =
            snapshot.data!;
        return Title(
            title: 'restaurantReviewsList',
            color: FlutterFlowTheme.of(context).primaryColor,
            child: Scaffold(
              key: scaffoldKey,
                                                              ...
                                                              builder: (context,
                                                                ...
                                                                return InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'RESTAURANT_REVIEWS_LIST_userInfo_ON_TAP');
                                                                    logFirebaseEvent(
                                                                    ...
                                                                    Column(
                                                                      mainAxisSize:
                                                                          MainAxisSize
                                                                              .max,
                                                                      children: [
                                                                        if (pageViewPostsRecord.hasReply ??
                                                                            true)
                                                                          Padding(
                                                                            padding: EdgeInsetsDirectional.fromSTEB(
                                                                                10.0,
                                                                            ...
                                                                            child:
                                                                                InkWell(
                                                                              onTap: () async {
                                                                                logFirebaseEvent('RESTAURANT_REVIEWS_LIST_VideoPlayer_nusg');
                                                                              ...
                                                                              child: FlutterFlowVideoPlayer(
                                                                                path: pageViewPostsRecord.videoReplyURL!,
                                                                                videoType: VideoType.network,
                                                                                width: 54.0,
                                                                                height: 96.0,
                                                                                autoPlay: false,
                                                                    ...
                                                                    if (pageViewPostsRecord
                                                                      ...
                                                                      Row(
                                                                        mainAxisSize:
                                                                            MainAxisSize.max,
                                                                        children: [
                                                                          if (userInfoRestaurantsRecord.userConnection ==
                                                                            ...
                                                                            Align(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    logFirebaseEvent('RESTAURANT_REVIEWS_LIST_REPLY_BTN_ON_TAP');
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('RESTAURANT_REVIEWS_LIST_Container_rclqo3');
                                                                    ...
                                                                    Card(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'RESTAURANT_REVIEWS_LIST_close_rounded_IC');
                                                                          logFirebaseEvent(
                                                                    ...
                                                                    Card(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'RESTAURANT_REVIEWS_LIST_flag_rounded_ICN');
                                                                          logFirebaseEvent(
                                                                    ...
                                                                    Card(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('RESTAURANT_REVIEWS_LIST_LottieAnimation_');
                                                                    ...
                                                                    Card(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'RESTAURANT_REVIEWS_LIST_mapMarkerAlt_ICN');
                                                                          logFirebaseEvent(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              final savedPostsElement = pageViewPostsRecord.reference;
                                                                            ...
                                                                            value:
                                                                                containerUsersRecord.savedPosts!.toList().contains(pageViewPostsRecord.reference),
                                                                            onIcon:
                                                                                FaIcon(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'RESTAURANT_REVIEWS_LIST_Text_fgh5e9ad_ON');
                                                                    logFirebaseEvent(
                                                                        'Text_bottom_sheet');
                                                                    await showModalBottomSheet(
                                                                      isScrollControlled:
                                                                  ...
                                                                  Stack(
                                                                    ...
                                                                    children: [
                                                                      StreamBuilder<
                                                                          UsersRecord>(
                                                                        stream:
                                                                            UsersRecord.getDocument(pageViewPostsRecord.user!),
                                                                        builder:
                                                                            (context,
                                                                                snapshot) {
                                                                          // Customize what your widget looks like when it's loading.
                                                                          ...
                                                                          return Container(
                                                                            ...
                                                                            child:
                                                                                InkWell(
                                                                              onTap: () async {
                                                                                logFirebaseEvent('RESTAURANT_REVIEWS_LIST_CircleImage_w115');
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                      ...
                                                                      child: StreamBuilder<
                                                                          RestaurantsRecord>(
                                                                        stream:
                                                                            RestaurantsRecord.getDocument(pageViewPostsRecord.restRef!),
                                                                        builder:
                                                                            (context,
                                                                                snapshot) {
                                                                          // Customize what your widget looks like when it's loading.
                                                                          ...
                                                                          return Column(
                                                                            ...
                                                                            children: [
                                                                              InkWell(
                                                                                onTap: () async {
                                                                                  logFirebaseEvent('RESTAURANT_REVIEWS_LIST_commentSection_O');
                                                                                ...
                                                                                child: Row(
                                                                                  ...
                                                                                  children: [
                                                                                    InkWell(
                                                                                      onTap: () async {
                                                                                        logFirebaseEvent('RESTAURANT_REVIEWS_LIST_Icon_9mgha19u_ON');
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              InkWell(
                                                                                onTap: () async {
                                                                                  logFirebaseEvent('RESTAURANT_REVIEWS_LIST_Icon_vs1m35jb_ON');
                                                                                  logFirebaseEvent('Icon_bottom_sheet');
                                                                                  await showModalBottomSheet(
                                                                                    isScrollControlled: true,
                                                                                    context: context,
                                                                          ...
                                                                          Text(
                                                                            pageViewPostsRecord.numComments!.toString(),
                                                                            style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                  fontFamily: 'Lexend Deca',
                                                                                  color: FlutterFlowTheme.of(context).tertiaryColor,
                                                                                ),
                                                                              ...
                                                                              children: [
                                                                                if (!pageViewPostsRecord.likes!.toList().contains(currentUserReference))
                                                                                  Align(
                                                                                    ...
                                                                                    child: InkWell(
                                                                                      onTap: () async {
                                                                                        logFirebaseEvent('RESTAURANT_REVIEWS_LIST_Icon_48wqwfl3_ON');
                                                                                ...
                                                                                if (pageViewPostsRecord.likes!.toList().contains(currentUserReference))
                                                                                  Align(
                                                                                    ...
                                                                                    child: InkWell(
                                                                                      onTap: () async {
                                                                                        logFirebaseEvent('RESTAURANT_REVIEWS_LIST_Icon_3vha9yfp_ON');
                                                                                        logFirebaseEvent('Icon_backend_call');
