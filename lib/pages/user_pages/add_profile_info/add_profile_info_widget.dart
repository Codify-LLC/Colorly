...
import 'add_profile_info_model.dart';
export 'add_profile_info_model.dart';
...
class _AddProfileInfoWidgetState extends State<AddProfileInfoWidget> {
  late AddProfileInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddProfileInfoModel());
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Visibility(
                              visible: functions
                                  .hasUploadedMedia(_model.uploadedFileUrl1),
                              child: InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    contentPadding:
                                        EdgeInsetsDirectional.fromSTEB(
                                            0.0, 8.0, 0.0, 0.0),
                                    suffixIcon:
                                        _model.bioController!.text.isNotEmpty
                                            ? InkWell(
                                                onTap: () async {
                                                  _model.bioController?.clear();
                                                  setState(() {});
                                                },
                                                child: Icon(
                                                  Icons.clear,
