...
import 'post_collage_model.dart';
export 'post_collage_model.dart';

class PostCollageWidget extends StatefulWidget {
  const PostCollageWidget({
    Key? key,
    this.user,
  }) : super(key: key);
  ...
  @override
  _PostCollageWidgetState createState() => _PostCollageWidgetState();
}

class _PostCollageWidgetState extends State<PostCollageWidget> {
  late PostCollageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostCollageModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'postCollage'});
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('POST_COLLAGE_arrow_back_rounded_ICN_ON_T');
                                  ...
                                  return Stack(
                                    children: [
                                      InkWell(
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'POST_COLLAGE_PAGE_Image_0lm7fbbt_ON_TAP');
                                          logFirebaseEvent(
                                              'Image_backend_call');
