...
class _ProfileHomeWidgetState extends State<ProfileHomeWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'profileHome'});
    setupAnimations(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('PROFILE_HOME_arrow_back_rounded_ICN_ON_T');
                        ...
                        children: [
                          if (Theme.of(context).brightness == Brightness.light)
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'PROFILE_HOME_PAGE_isLightMode_ON_TAP');
                                logFirebaseEvent(
                          ...
                          if (Theme.of(context).brightness == Brightness.dark)
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'PROFILE_HOME_PAGE_isDarkMode_ON_TAP');
                                logFirebaseEvent(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROFILE_HOME_PAGE_Row_0ings4tt_ON_TAP');
                              logFirebaseEvent('Row_navigate_to');

                              context.pushNamed('toggleNotifications');
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'htyugot9' /* Notification Settings */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText2
                                        .override(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROFILE_HOME_PAGE_Row_k7ad8gi0_ON_TAP');
                              logFirebaseEvent('Row_navigate_to');
