    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'service':
          ...
          break;
        case 'cleanliness':
          result.cleanliness = serializers.deserialize(value,
              specifiedType: const FullType(double)) as double?;
          break;
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, videoUrl.hashCode), restaurantName.hashCode), userRating.hashCode), createdAt.hashCode), description.hashCode), user.hashCode), username.hashCode), restRef.hashCode), likes.hashCode), videoThumbnail.hashCode), postOwner.hashCode), numLikes.hashCode), numComments.hashCode), numShares.hashCode),
                                                                                wacthed.hashCode),
                                                                            isFlagged.hashCode),
...
class PostsRecordBuilder implements Builder<PostsRecord, PostsRecordBuilder> {
  ...
  double? _food;
  double? get food => _$this._food;
  set food(double? food) => _$this._food = food;

  double? _service;
  double? get service => _$this._service;
  set service(double? service) => _$this._service = service;

  double? _cleanliness;
  double? get cleanliness => _$this._cleanliness;
  set cleanliness(double? cleanliness) => _$this._cleanliness = cleanliness;
