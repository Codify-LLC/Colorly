...
class _$FriendsRecord extends FriendsRecord {
  ...
  _$FriendsRecord._({this.follower, this.following, this.ffRef}) : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc(0, follower.hashCode), following.hashCode), ffRef.hashCode));
  }
  ...
  _$FriendsRecord _build() {
    final _$result = _$v ??
        new _$FriendsRecord._(
            follower: follower, following: following, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
