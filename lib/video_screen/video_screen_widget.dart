...
import 'video_screen_model.dart';
export 'video_screen_model.dart';
...
class _VideoScreenWidgetState extends State<VideoScreenWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoScreenModel());
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return InkWell(
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'VIDEO_SCREEN_PAGE_userInfo_ON_TAP');
                                                                  logFirebaseEvent(
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('VIDEO_SCREEN_PAGE_Column_slkfb3w9_ON_TAP');
                                                                            ...
                                                                            await userInfoRestaurantsRecord.reference.update(restaurantsUpdateData);
                                                                      ...
                                                                      if (pageViewPostsRecord
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('VIDEO_SCREEN_VideoPlayer_sky8yfsn_ON_TAP');
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        if (userInfoRestaurantsRecord.userConnection ==
                                                                          ...
                                                                          Align(
                                                                            alignment:
                                                                                AlignmentDirectional(0.97, -0.57),
                                                                            child:
                                                                                Padding(
                                                                    ...
                                                                    Align(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('VIDEO_SCREEN_Container_o9608l5i_ON_TAP');
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('VIDEO_SCREEN_CircleImage_9tulglr0_ON_TAP');
