...
class GiftFizzzCopyWidget extends StatefulWidget {
  ...
  @override
  _GiftFizzzCopyWidgetState createState() => _GiftFizzzCopyWidgetState();
}
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        '5oa8qhp4' /* Learn More ABout FIZZZ */,
                                      ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        't9o3qx2i' /* Use Fizzz at your favorite res... */,
                      ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'f6b906d7' /* Earn more coin while holding */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyText2.override(
                            fontFamily: 'Lexend Deca',
                            color: Color(0xFF090F13),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '1lzhu02o' /* Withdraw for monetary value wh... */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyText2.override(
                            fontFamily: 'Lexend Deca',
                            color: Color(0xFF090F13),
