...
class EditRestaurantModel extends FlutterFlowModel {
  ...
  // State field(s) for ChoiceChips widget.
  List<String>? choiceChipsValues6;
  // State field(s) for ChoiceChips widget.
  List<String>? choiceChipsValues7;
  // State field(s) for ChoiceChips widget.
  List<String>? choiceChipsValues8;
  // State field(s) for ChoiceChips widget.
  List<String>? choiceChipsValues9;
