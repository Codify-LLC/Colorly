...
import '../components/add_menu_to_stream_widget.dart';
import '../components/choose_restaurant_widget.dart';
import '../components/comments_stream_widget.dart';
...
class BroadcastPageWidget extends StatefulWidget {
  const BroadcastPageWidget({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('BROADCAST_arrow_back_rounded_ICN_ON_TAP');
                ...
                child: Padding(
                  ...
                  child: FlutterFlowMuxBroadcast(
                    ...
                    onStartButtonTap: () async {
                      ...
                      logFirebaseEvent(
                          'BROADCAST_MuxBroadcast_0x7q0dvv_ON_MUX_B');
                      ...
                      streamOutput = StreamsRecord.getDocumentFromData(
                    ...
                    onStopButtonTap: () async {
                      ...
                      await streamOutput!.reference.update(streamsUpdateData);
                      logFirebaseEvent('MuxBroadcast_Navigate-To');
                      ...
                      child: Row(
                        ...
                        children: [
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'BROADCAST_fastfood_rounded_ICN_ON_TAP');
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'BROADCAST_storefront_ICN_ON_TAP');
                              logFirebaseEvent('IconButton_Bottom-Sheet');
                              await showModalBottomSheet(
                                isScrollControlled: true,
                                backgroundColor: Colors.transparent,
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'BROADCAST_mark_chat_unread_rounded_ICN_O');
                              logFirebaseEvent('IconButton_Bottom-Sheet');
                              await showModalBottomSheet(
                                isScrollControlled: true,
                                backgroundColor: Colors.transparent,
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'efe943ng' /* Start streaming to add feature... */,
                            ),
