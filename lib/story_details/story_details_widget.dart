                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return InkWell(
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'STORY_DETAILS_PAGE_userInfo_ON_TAP');
                                                                  logFirebaseEvent(
                                                                        ...
                                                                        Card(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                InkWell(
                                                                              onTap: () async {
                                                                                logFirebaseEvent('STORY_DETAILS_LottieAnimation_tcfsb1v0_O');
                                                                ...
                                                                return Row(
                                                                  ...
                                                                  crossAxisAlignment:
                                                                      CrossAxisAlignment
                                                                          .end,
                                                                  children: [
                                                                    if (!(currentUserDocument?.usedDeals?.toList() ??
                                                                            [])
                                                                        .contains(
                                                                            userInfoDealsRecord.reference))
