                                        ...
                                        Container(
                                          ...
                                          child: FlutterFlowVideoPlayer(
                                            path: valueOrDefault<String>(
                                              pageViewStoriesRecord.videoUrl,
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'STORY_DETAILS_CircleImage_u24thydo_ON_TA');
                                                                  logFirebaseEvent(
                                                              ...
                                                              Card(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'STORY_DETAILS_flag_rounded_ICN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'STORY_DETAILS_LottieAnimation_tcfsb1v0_O');
                                                                          logFirebaseEvent(
                                                                          ...
                                                                          context
                                                                            ...
                                                                            queryParams:
                                                                                {
                                                                              'restaurant': serializeParam(userInfoRestaurantsRecord, ParamType.Document),
                                                                            }.withoutNulls,
                                                                            extra: <String,
                                                                                dynamic>{
                                                                      ...
                                                                      children: [
                                                                        Stack(
                                                                          children: [
                                                                            InkWell(
                                                                              onTap: () async {
                                                                                logFirebaseEvent('STORY_DETAILS_Container_t5grt86g_ON_TAP');
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'STORY_DETAILS_PAGE_LEARN_MORE_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_Launch-U-R-L');
                                                          await launchURL(
                                                              pageViewStoriesRecord
