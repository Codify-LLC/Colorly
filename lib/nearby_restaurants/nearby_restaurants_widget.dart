...
import 'nearby_restaurants_model.dart';
export 'nearby_restaurants_model.dart';
...
class _NearbyRestaurantsWidgetState extends State<NearbyRestaurantsWidget> {
  late NearbyRestaurantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NearbyRestaurantsModel());
          ...
          body: SafeArea(
            child: FutureBuilder<List<RestaurantsRecord>>(
              future: (_model.algoliaRequestCompleter ??=
                      Completer<List<RestaurantsRecord>>()
              ...
              builder: (context, snapshot) {
                ...
                return RefreshIndicator(
                  onRefresh: () async {
                    logFirebaseEvent(
                        'NEARBY_RESTAURANTS_ListView_qg8fo2vc_ON_');
